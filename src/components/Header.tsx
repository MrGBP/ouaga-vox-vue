    ...
    <header className="sticky top-0 z-50 bg-card/85 backdrop-blur-xl border-b border-border/60">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center group" aria-label="SapSapHouse — Accueil">
            <motion.img
              src={logoFull}
              alt="SapSapHouse — Mon bien Immo en un clic"
              whileHover={{ scale: 1.03 }}
              transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
              className="h-12 md:h-14 w-auto object-contain drop-shadow-[0_2px_6px_rgba(26,53,96,0.15)]"
              loading="eager"
              decoding="async"
            />
          </Link>
